package com.qujia.mvc.config;

import com.qujia.mvc.interceptors.FirstInterceptor;
...
//8-拦截器
@Configuration
@ComponentScan("com.qujia.mvc.controller")//1-扫描组件
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(firstInterceptor).addPathPatterns("/**");//添加拦截路径  exclud那个是排除
    }
    //配置视图控制3-view-controller
    @Override
